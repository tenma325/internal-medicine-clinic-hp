...
<main>
  ...
  <section class="section section-soft" id="services">
    <div class="container">
      ...
      <div class="cards">
        <article class="card"><div class="card__icon" data-icon="🩺" aria-hidden="true"></div><h3>一般内科</h3><p>発熱、咳、腹痛、頭痛、倦怠感など、急な体調不良から継続的な相談まで幅広く診療します。</p></article>
        <article class="card"><div class="card__icon" data-icon="💚" aria-hidden="true"></div><h3>生活習慣病</h3><p>高血圧、脂質異常症、糖尿病など、検査結果や日常生活に合わせて継続的にサポートします。</p></article>
        <article class="card"><div class="card__icon" data-icon="🛡️" aria-hidden="true"></div><h3>健診・予防接種</h3><p>健康診断、各種ワクチン、診断書の相談など、予防医療の窓口としてご利用いただけます。</p></article>
      </div>
    </div>
  </section>
  <section class="section"><div class="container feature-grid"><div class="feature-panel"><h2>シンプルで更新しやすい、WordPress向けの設計</h2><p>テンプレートやテーマをベースに手を入れすぎず、医院情報を分かりやすく伝えることを優先しています。</p></div><div class="feature-list"><div class="feature-list__item"><span class="feature-icon" data-icon="LP" aria-hidden="true"></span><div><h3>トップページはランディングページ型</h3><p>診療案内、特徴、診療時間、予約、アクセスまで1ページ内で自然に確認できます。</p></div></div><div class="feature-list__item"><span class="feature-icon" data-icon="予" aria-hidden="true"></span><div><h3>スマホでも迷わない予約導線</h3><p>ヘッダーとCTAからWeb予約ページへ誘導。後日予約システムの埋め込みを差し替えできます。</p></div></div><div class="feature-list__item"><span class="feature-icon" data-icon="清" aria-hidden="true"></span><div><h3>医療サイトらしい清潔感</h3><p>緑系・白背景・角丸カードを中心に、健康的でナチュラルな印象に整えました。</p></div></div></div></div></section>
